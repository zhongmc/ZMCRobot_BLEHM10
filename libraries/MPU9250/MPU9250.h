...
//company
    ...
    // float gyroBias[3] = {-1.49, -0.24, -0.08}; // bias corrections
    // float magBias[3] = {142.51, -1891.25, -3470.35};
    // float magScale[3]  = {0.98, 1.07, 0.96}; // Bias corrections for gyro and accelerometer
